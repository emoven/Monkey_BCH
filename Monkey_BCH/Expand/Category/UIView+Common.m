...
- (void)doCircleFrame{
    ...
    self.layer.borderColor = kHexColor(0xdddddd).CGColor;//[UIColor colorWithHexString:@""].CGColor;
}
...
- (void)doBorderWidth:(CGFloat)width color:(UIColor *)color cornerRadius:(CGFloat)cornerRadius{
    ...
    if (!color) {
        self.layer.borderColor = kHexColor(0xdddddd).CGColor;//[UIColor colorWithHexString:@"0xdddddd"].CGColor;
    }else{
...
- (void)addBadgePoint:(NSInteger)pointRadius withPointPosition:(CGPoint)point {
    ...
    badgeView.tag = kTagBadgePointView;
    badgeView.layer.cornerRadius = pointRadius;
    badgeView.backgroundColor = kHexColor(0xf75388);//[UIColor colorWithHexString:@"0xf75388"];
...
+ (UIView *)lineViewWithPointYY:(CGFloat)pointY{
    return [self lineViewWithPointYY:pointY andColor:kHexColor(0xc8c7cc)];
}
...
- (void)addLineUp:(BOOL)hasUp andDown:(BOOL)hasDown{
    [self addLineUp:hasUp andDown:hasDown andColor:kHexColor(0xc8c7cc)];
}
    ...
    if (hasError) {
        ...
        if ((blankPageType>=EaseBlankPageTypeProject_ALL)&&(blankPageType<=EaseBlankPageTypeProject_STARED)) {
            ...
            UIButton *actionBtn=({
                ...
                button.backgroundColor=kHexColor(0x3BBD79);//[UIColor colorWithHexString:@"0x3BBD79"];
