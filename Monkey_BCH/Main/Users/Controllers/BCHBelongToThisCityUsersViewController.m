//
//  BCHBelongToThisCityUsersViewController.m
//  Monkey_BCH
//
...
@interface BCHBelongToThisCityUsersViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BCHBelongToThisCityUsersViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSString *location = kUserDefaultObjectForKey(kSelectCityKey);
    if (kIsEmptyString(location)) {
        location = NSLocalizedString(@"beijing", @"");
    }
...
-(void)loadNewUsers{
    ...
    [HYBNetworking getWithUrl:url refreshCache:YES success:^(id response) {
        ...
        if (_belongToThisCityUsersBlock) {
            _belongToThisCityUsersBlock(self,totalCount);
        }
