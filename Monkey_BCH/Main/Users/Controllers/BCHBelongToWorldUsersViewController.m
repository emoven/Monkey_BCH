//
//  BCHBelongToWorldUsersViewController.m
//  Monkey_BCH
//
...
@interface BCHBelongToWorldUsersViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BCHBelongToWorldUsersViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if (kIsEmptyString(language)) {
        ...
        kUserDefaultSetObjectForKey(@"Objective-C", kSelectLanguageKey);
    }
...
-(void)loadNewUsers{
    ...
    [HYBNetworking getWithUrl:url refreshCache:YES success:^(id response) {
        ...
        if (_belongToWorldUsersBlock) {
            _belongToWorldUsersBlock(self,totalCount);
        }
