...
//  TYHomeland
//
//  Created by yiliao on 16/8/22.
//  Copyright © 2016年 Yao. All rights reserved.
//

#import "BCHInputTextView.h"

@interface BCHInputTextView()
...
@implementation BCHInputTextView
...
- (void)setYz_textHeightChangeBlock:(void (^)(NSString *, CGFloat))yz_textChangeBlock{
    _bch_textHeightChangeBlock = yz_textChangeBlock;
    [self textDidChange];
}
...
- (void)textDidChange{
    ...
    if (_textH != height) { // 高度不一样，就改变了高度
        ...
        _textH = height;
        if (_bch_textHeightChangeBlock && self.scrollEnabled == NO) {
            _bch_textHeightChangeBlock(self.text,height);
