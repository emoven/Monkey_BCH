...
+ (CGSize)badgeSizeWithStr:(NSString *)badgeValue font:(UIFont *)font{
    ...
    CGSize badgeSize = [badgeValue bch_getSizeWithFont:font constrainedToSize:CGSizeMake(kMaxBadgeWith, 20)];
...
- (void)commonInitialization {
    ...
    _badgeBackgroundColor = kHexColor(0xf75388);//[UIColor colorWithHexString:@""];
