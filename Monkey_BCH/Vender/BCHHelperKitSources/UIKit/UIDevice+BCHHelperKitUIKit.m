...
@implementation UIDevice (BCHHelperKitUIKit)
...
{
    NSString *platform = [self bch_devicePlatform];
    // iPhone
...
+(BOOL)bch_isiPad
{
    return [[[self bch_devicePlatform] substringToIndex:4] isEqualToString:@"iPad"];
}

+ (BOOL)bch_isiPhone {
    return [[[self bch_devicePlatform] substringToIndex:6] isEqualToString:@"iPhone"];
}

+ (BOOL)bch_isiPod {
    return [[[self bch_devicePlatform] substringToIndex:4] isEqualToString:@"iPod"];
}

+ (BOOL)bch_isSimulator {
    return [[self bch_devicePlatform] isEqualToString:@"i386"]
    || [[self bch_devicePlatform] isEqualToString:@"x86_64"];
}
